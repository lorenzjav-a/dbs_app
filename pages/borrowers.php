...
$addBorrowerCreateStatus = null;
$addBorrowerCreateMessage = '';
...
if(isset($_POST['add_address'])){
  ...
  $addBorrowerCreateStatus = 'Success';
  $addBorrowerCreateMessage = 'Borrower Address created successfully.';


  } catch (Exception $e){

    $addBorrowerCreateStatus = 'Error';
    $addBorrowerCreateMessage = $e->getMessage();
          ...
          <div class="card p-4 h-100">
            ...
            <form action="#" method="POST" class="row g-2">
              <div class="col-12">
                ...
                <label class="form-label">Borrowers</label>

                <select class="form-select" name="borrower_id" required>
                  <option value="">Select borrower</option>
                  <?php
                  foreach($allusers as $borrowers){
                 echo '<option value="'.$borrowers['borrower_id'] . '">'.$borrowers['borrower_firstname']. ' '. 
              ...
              <div class="col-12">
                <button name="add_address" class="btn-outline-primary w-100" type="submit">Add Address</button>
              </div>
            </form>
          </div>
        </div>
...
<script>
  ...
  const createStatus = <?php echo json_encode($addBorrowerCreateStatus)?>;
  const createMessage = <?php echo json_encode($addBorrowerCreateMessage)?>;
